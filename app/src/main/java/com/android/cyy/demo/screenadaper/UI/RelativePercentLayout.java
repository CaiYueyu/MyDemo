package com.android.cyy.demo.screenadaper.UI;
...
public class RelativePercentLayout extends RelativeLayout {
    ...
    public RelativePercentLayout(Context context) {
        super(context);
    }

    public RelativePercentLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public RelativePercentLayout(Context context, AttributeSet attrs, int defStyleAttr) {
